...
const introduce: IIntroduce.Payload = {
  ...
  contents: [
    ...
    '오픈소스 프로젝트에 관심이 많고, 다양한 방법으로 기여를 하려고 노력하고 있습니다. 이외에도 개인 프로젝트나 개발 커뮤니티 활동 등을 통해 다양한 개발 경험을 즐기고 있습니다. 이러한 개발 경험을 공유하는 것을 좋아하여 시작한 기술 경험 공유 네트워크는 어느덧 300여 명의 사람들과 함께하고 있습니다. 언제나 백엔드 개발의 정점을 찍고 싶다고 생각하고 있으며, 조금 더 나중에는 어딘가의 기술 조직 리더라는 목표를 가지고 다양한 기술을 학습하거나 사용하고 경험을 쌓고 있습니다.',
